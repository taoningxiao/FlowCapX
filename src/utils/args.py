def config_parser():
    ...
    parser.add_argument("--sampleX", type=int, default=640)
    parser.add_argument("--sampleY", type=int, default=960)
    parser.add_argument("--sampleZ", type=int, default=640)
    ...
    parser.add_argument("--dens_color", type=int, default=100)
