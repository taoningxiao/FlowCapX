...
def save_log(args):
    ...
    expname = expname + "_" + date_str
    os.makedirs(os.path.join(basedir, expname), exist_ok=True)
    targetdir = os.path.join(basedir, expname)
    ...
    os.mkdir(os.path.join(targetdir, "image"))
    os.mkdir(os.path.join(targetdir, "video"))
    os.mkdir(os.path.join(targetdir, "ckpt"))

    return filedir, writer, targetdir
