...
if withCuda:
    ...
    print("The code was tested on a single NVIDIA RTX 4090 GPU with 24G memory.\nTo work with smaller memory, parameters need modifications.\nTo use multiple GPUs, code needs to be modified.")
else:
    print("[WARNING] You are supposed to use pytorch with cuda")

from raymarching import morton2D, morton2D_invert

print("finish raymarching test")

print("[SUCCESS] Pass environment test")